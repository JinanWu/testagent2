...
def test_額外ledger列最多只讀expected加一即失敗(資料庫, monkeypatch):
    with closing(sqlite3.connect(資料庫)) as 連線, 連線:
        連線.execute("INSERT INTO published_api_schema_migrations VALUES(17,'ADVERSARIAL_EXTRA_G05',0)")
        連線.execute("INSERT INTO published_api_schema_migrations VALUES(18,'UNREAD_EXTRA_G05',0)")
