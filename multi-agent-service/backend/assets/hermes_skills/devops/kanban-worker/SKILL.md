---
name: kanban-worker
description: Hermes Kanban worker 的陷阱、範例與邊界情況。生命週期本身會自動以 KANBAN_GUIDANCE（來自 agent/prompt_builder.py）注入到每個 worker 的系統提示中；當你需要針對特定情境有更深入細節時，請載入此技能。
version: 2.0.0
platforms: [linux, macos, windows]
metadata:
  hermes:
    tags: [kanban, 多代理, 協作, 工作流程, 陷阱]
