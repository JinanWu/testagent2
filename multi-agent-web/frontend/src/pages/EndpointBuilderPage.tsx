...
import PublishedEndpointTester from '../features/endpoints/PublishedEndpointTester'
        ...
        */}
        {success?.kind === 'new' && (
          <section
            role="status"
            aria-live="polite"
            className="flex flex-col items-center gap-xl py-xl text-center"
          >
            ...
            {draft && (
              <div className="w-full max-w-[56rem]">
                <PublishedEndpointTester
                  slug={slug}
                  apiKey={success.initialApiKey}
                  inputSchema={draft.preview.inputSchema}
                />
              </div>
            )}
